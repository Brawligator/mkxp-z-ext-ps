...
static void mriBindingExecute() {
    ...
    if (conf.editor.debug)
    {
        ...
        rb_eval_string(
            ...
            "      # Skip lines within our own wrapper and this module\n"
            ...
            "end\n"
            "\n"
            "# Redirect $stdout and $stderr through the console system\n"
            "# so they don't bypass the console thread and corrupt the display\n"
            "$stdout = Object.new\n"
            "def $stdout.write(str)\n"
            "  str.to_s.split(\"\\n\", -1).each_with_index do |line, i|\n"
            "    System._console_write(line) unless line.empty?\n"
            "  end\n"
            "  str.length\n"
            "end\n"
            ...
            "  nil\n"
            "end\n"
            "def $stdout.print(*args) args.each { |a| write(a.to_s) }; nil end\n"
            "def $stdout.flush; self end\n"
            "$stderr = $stdout\n"
        );
    }
